    ...
    <header id="header" class="d-flex align-items-center ">
        <div class="container-fluid container-xxl d-flex align-items-center">
            ...
            <div id="logo" class="me-auto">
                ...
                <a href="index.html" class="scrollto"><img src="{{ asset('assets/logoramajaya.png') }}" alt=""
                        title=""></a>
            </div>
            ...
            <a target="_blank" class="buy-tickets scrollto"
                href="https://instagram.com/cvramajaya?igshid=YmMyMTA2M2Y=">Instagram</a>
    ...
    <main id="main">
            ...
            <div class="container" data-aos="fade-up">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <p>CV. Rama Jaya merupakan sebuah perusahaan swasta yang bergerak di bidang jasa konstruksi
                            besi. Produk yang ditawarkan oleh CV. Rama Jaya mulai dari canopy membrane, pintu
                            henderson, folding gate, railing tangga, pagar, tralis, tenda kain, stainless steel, balkon,
                            dan aksesoris bangunan lainnya dan CV. Rama Jaya melayani permintaan konstruksi besi dan
                            jasa pemasangan konstruksi besi. Lokasi CV. Rama Jaya.</p>
                    </div>
                    {{-- <div class="col-lg-3">
            <h3>Where</h3>
        ...
        <section id="speakers">
            <div class="container" data-aos="fade-up">
                ...
                <div class="row">
                    @foreach (App\Portfolio::all() as $item)
                ...
                <div class="row g-0">
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="venue-gallery">
                            <a href="{{ asset('frontend') }}/assets/img/venue-gallery/1.jpg" class="glightbox"
                                data-gall="venue-gallery">
                                <img src="{{ asset('frontend') }}/assets/img/venue-gallery/1.jpg" alt=""
                                    class="img-fluid">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="venue-gallery">
                            <a href="{{ asset('frontend') }}/assets/img/venue-gallery/2.jpg" class="glightbox"
                                data-gall="venue-gallery">
                                <img src="{{ asset('frontend') }}/assets/img/venue-gallery/2.jpg" alt=""
                                    class="img-fluid">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="venue-gallery">
                            <a href="{{ asset('frontend') }}/assets/img/venue-gallery/3.jpg" class="glightbox"
                                data-gall="venue-gallery">
                                <img src="{{ asset('frontend') }}/assets/img/venue-gallery/3.jpg" alt=""
                                    class="img-fluid">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="venue-gallery">
                            <a href="{{ asset('frontend') }}/assets/img/venue-gallery/4.jpg" class="glightbox"
                                data-gall="venue-gallery">
                                <img src="{{ asset('frontend') }}/assets/img/venue-gallery/4.jpg" alt=""
                                    class="img-fluid">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="venue-gallery">
                            <a href="{{ asset('frontend') }}/assets/img/venue-gallery/5.jpg" class="glightbox"
                                data-gall="venue-gallery">
                                <img src="{{ asset('frontend') }}/assets/img/venue-gallery/5.jpg" alt=""
                                    class="img-fluid">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="venue-gallery">
                            <a href="{{ asset('frontend') }}/assets/img/venue-gallery/6.jpg" class="glightbox"
                                data-gall="venue-gallery">
                                <img src="{{ asset('frontend') }}/assets/img/venue-gallery/6.jpg" alt=""
                                    class="img-fluid">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="venue-gallery">
                            <a href="{{ asset('frontend') }}/assets/img/venue-gallery/7.jpg" class="glightbox"
                                data-gall="venue-gallery">
                                <img src="{{ asset('frontend') }}/assets/img/venue-gallery/7.jpg" alt=""
                                    class="img-fluid">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="venue-gallery">
                            <a href="{{ asset('frontend') }}/assets/img/venue-gallery/8.jpg" class="glightbox"
                                data-gall="venue-gallery">
                                <img src="{{ asset('frontend') }}/assets/img/venue-gallery/8.jpg" alt=""
                                    class="img-fluid">
                            </a>
                        </div>
                    </div>
